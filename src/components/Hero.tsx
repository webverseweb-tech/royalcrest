    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <motion.div
          ...
          className="mx-auto mb-12 h-44 w-44 md:h-56 md:w-56 rounded-full border-4 border-primary/40 bg-[hsl(222,47%,5%)] backdrop-blur-md flex items-center justify-center overflow-hidden shadow-2xl shadow-primary/15">
          
          <img alt="Royal Crest" className="h-[200%] w-[200%] object-cover object-center" src={logo} />
        </motion.div>
