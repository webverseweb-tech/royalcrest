            ...
            onClick={() => setSelected(i)}>
              ...
              <div className="p-7">
                ...
                <div className="mt-5 flex items-center gap-5">
                  ...
                  onClick={(e) => e.stopPropagation()} href="tel:+18683332665">
        ...
        onClick={() => setSelected(null)}>
          ...
          onClick={(e) => e.stopPropagation()}>
            ...
            <div className="relative">
              ...
              <button
              onClick={() => setSelected(null)}
              className="absolute top-4 right-4 bg-background/50 backdrop-blur-sm rounded-full p-2.5 text-foreground hover:text-primary transition-colors">
            ...
            <div className="p-8">
              <div className="flex items-center gap-4 mb-4">
                <span className="text-4xl">{divisions[selected].icon}</span>
              ...
              <div className="mb-8">
                <h4 className="font-display text-lg font-bold text-foreground mb-5">
                  What We Offer
                </h4>
              ...
              <a
              href="#contact"
              className="gold-button w-full justify-center text-base"
              onClick={() => setSelected(null)}>
